...
MVE-20260404-02 Condition 4: NCA-LLM qwen2.5:7b x 3 nodes (homogeneous).
"""
...
RESULTS_PATH = RESULTS_DIR / "nca_7b_results.jsonl"
...
def main():
    ...
    print("=" * 60)
    print(f"NCA-LLM v2: qwen2.5:7b x 3 nodes (homogeneous)")
    ...
    with open(RESULTS_PATH, mode, encoding="utf-8") as f_out:
        for task in remaining:
            ...
            if done % 10 == 0 or done == total:
                ...
                print(f"  [NCA-7b] {done}/{total} ({acc:.1f}% acc) last={elapsed:.1f}s")
