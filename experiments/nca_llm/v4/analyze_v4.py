...
MVE-20260404-04: Model diversity effect on groupthink.
...
FILES = {
    ...
    "3b_true_het": BASE / "v4" / "nca_3b_true_het_results.jsonl",
...
LABELS = {
    "3b_homo": "NCA 3b homo",
    "3b_true_het": "NCA 3b true-het <- NEW",
    "7b_homo": "NCA 7b homo",
...
def main():
    ...
    print("=" * 72)
    print("MVE-20260404-04 Results: True 3b Heterogeneous NCA")
    print("=" * 72)

    print(f"{'Condition':<24}| {'Error Rate':<22}| {'CFR':<22}| {'Unanimity':>9}")
    print(f"{'-'*24}|{'-'*22}|{'-'*22}|{'-'*10}")

    for key in ["3b_homo", "3b_true_het", "7b_homo", "7b_hetero"]:
        s = stats[key]
    ...
    s3h, s3het = stats["3b_homo"], stats["3b_true_het"]
