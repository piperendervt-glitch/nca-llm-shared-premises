...
MVE-20260404-03: NCA-LLM 3b heterogeneous (3 different 3b-class models).
qwen2.5:3b (Solver) / llama3.2:3b (Verifier) / gemma2:2b (Critic)
"""
...
RESULTS_DIR = Path(__file__).resolve().parent.parent.parent.parent / "results" / "nca_llm" / "v3"
RESULTS_PATH = RESULTS_DIR / "nca_3b_heterogeneous_results.jsonl"
...
def main():
    ...
    print("=" * 60)
    print("NCA-LLM v3: 3b heterogeneous")
    ...
    with open(RESULTS_PATH, mode, encoding="utf-8") as f_out:
        for task in remaining:
            ...
            if done % 10 == 0 or done == total:
                ...
                print(f"  [NCA-3b-het] {done}/{total} ({acc:.1f}% acc) last={elapsed:.1f}s")
